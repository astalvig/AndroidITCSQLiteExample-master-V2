...
public class AddTodoActivity extends Activity implements OnClickListener {
	...
	private EditText todoPriority;	// Priority field
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		todoPriority	= (EditText)findViewById(R.id.newTodoPriority);
	...
	public void onClick(View v) {
		...
		if (addNewButton.isPressed()) {
			...
			todoText.setText("");
			Integer todoPriorityValue = Integer.parseInt(todoPriority.getText().toString());
			todoPriority.setText("");
